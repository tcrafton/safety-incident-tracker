...
const InjuryPage = () => {
  ...
  const checkEntries = () => {
    ...
    if (!accidentData.EXPECTED_OUTCOME) {
      notifyError('Select Likely Outcome');
      return false;
    }
    ...
    if (!accidentData.TASK_BEING_PERFORMED) {
      notifyError('Enter Task Being Performed');
      return false;
    }
  };
  ...
  return (
    <>
      <Wrapper>
        <h4 className="pageHeader">Injury Incident Entry</h4>
        ...
        <div>
          <Box>
            <Grid container justify="space-around" spacing={2}>
              ...
              <Grid item xs={2}>
                <InputLabel>Shift Incident Occurred On</InputLabel>
                <FormControl sx={{ minWidth: 120 }} size="small">
                  <TextField
                    style={{ width: '100%' }}
                    variant="outlined"
              ...
              <Grid item xs={2}>
                <InputLabel>Incident Date</InputLabel>
                <DatePicker
              ...
              <Grid item xs={3}>
                <InputLabel>Incident Time</InputLabel>
                <DatePicker
                  className="datePicker"
                  // placeholderText="Incident Time"
              ...
              <Grid item xs={6}>
                ...
                <TextareaAutosize
                  ...
                  value={accidentData.TASK_BEING_PERFORMED}
                  onChange={(e, label) =>
                    handleInputChange(e, 'TASK_BEING_PERFORMED')
                  }
                />
              </Grid>
              <Grid item xs={5}>
              ...
              <Grid item xs={6}>
                <InputLabel>Potential Outcome</InputLabel>
              ...
              <Grid item xs={6}>
                <InputLabel>Likely Outcome</InputLabel>
                <FormControl sx={{ minWidth: 240 }} size="small">
                  <TextField
                    style={{ width: '100%' }}
                    variant="outlined"
                    size="small"
                    value={accidentData.EXPECTED_OUTCOME}
                    onChange={(e, label) =>
                      handleInputChange(e, 'EXPECTED_OUTCOME')
                    }
                    select
                  >
                    {outcomes.map((outcome, i) => {
              ...
              <Grid item xs={12}>
                <InputLabel>Nature of Incident or Injury</InputLabel>
                <TextareaAutosize
                  minRows={5}
                  aria-label="empty textarea"
